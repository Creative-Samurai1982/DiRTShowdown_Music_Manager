...
def show_about_menu() -> None:
    ...
    # Show the runtime root in the EXE build (this is where docs are shipped)
    script_dir = get_script_dir()
    source_root = script_dir.parent if (script_dir.name.lower() == "app") else script_dir

    runtime = RUNTIME_ROOT if "RUNTIME_ROOT" in globals() else source_root
    bundle = BUNDLE_ROOT if "BUNDLE_ROOT" in globals() else source_root
    ...
    while True:
        ...
        console.print("")
        console.print("[dim]Enter a number to view, or 0 to return.[/dim]")
